...
import cn.v5cn.netty.im.common.domain.ResponseCollector;
...
public class ServerAckWindow {
    ...
    private final static Map<Serializable, ServerAckWindow> windowsMap;
    ...
    private final ConcurrentHashMap<Long, ResponseCollector<Internal.InternalMsg>> responseCollectorMap;
