package cn.v5cn.sb.netty.websocket;

import cn.v5cn.sb.netty.server.NettyServer;
import cn.v5cn.sb.netty.tcp.handler.NettyServerHandlerInitializer;
import cn.v5cn.sb.netty.websocket.handler.NettyWebSocketHandlerInitializer;
 ...
 */
@Component
public class NettyWebSocketServer implements NettyServer {
    ...
    @Autowired
    private NettyWebSocketHandlerInitializer webSocketHandlerInitializer;
    ...
    public void start() throws InterruptedException {
        ...
        bootstrap.group(bossGroup, workerGroup)
                ...
                .childHandler(webSocketHandlerInitializer);
