package cn.v5cn.springboot.websocket.util;
...
public class WebSocketUtil {
    ...
    public static void removeSession(WebSocketSession session) {
        // 从 SESSION_USER_MAP 中移出
        String user = SESSION_USER_MAP.remove(session);
        // 从 USER_SESSION_MAP中移出
...
//        RemoteEndpoint.Basic remote = session.get.getBasicRemote();
//        if(remote == null) {
//            LOGGER.error("[sendTextMessage][session 的 RemoteEndpoint.Basic  为 null]");
//            return;
//        }
        try {
