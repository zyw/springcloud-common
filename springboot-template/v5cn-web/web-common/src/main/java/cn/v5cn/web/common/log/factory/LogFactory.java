 ...
 */
package cn.v5cn.web.common.log.factory;

import cn.v5cn.web.common.Constants;
import cn.v5cn.web.common.log.BusinessLog;
import cn.v5cn.web.common.util.JoinPointUtil;
import cn.v5cn.web.common.log.LogSuccessStatusEnum;
import cn.v5cn.web.common.log.VisLogTypeEnum;
...
public class LogFactory {
    ...
    static void createSysLoginLog(SysVisLog sysVisLog, String account, String successCode, String failMessage) {
        ...
        sysVisLog.setCreateTime(LocalDateTime.now());
        ...
        if (LogSuccessStatusEnum.FAIL.getCode().equals(successCode)) {
            sysVisLog.setMessage(VisLogTypeEnum.LOGIN.getMessage() +
                    LogSuccessStatusEnum.FAIL.getMessage() + Constants.COLON + failMessage);
        }
    }
