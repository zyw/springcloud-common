...
import cn.powertime.csp.core.Constants;
...
public class UaUtil {
    ...
    public static String getBrowser(HttpServletRequest request) {
        ...
        if (ObjectUtil.isEmpty(userAgent)) {
            ...
            return Constants.UNKNOWN.equals(browser) ? Constants.DASH : browser;
        }
    }
    ...
    public static String getOs(HttpServletRequest request) {
        ...
        if (ObjectUtil.isEmpty(userAgent)) {
            ...
            return Constants.UNKNOWN.equals(os) ? Constants.DASH : os;
        }
    }
    ...
    private static UserAgent getUserAgent(HttpServletRequest request) {
        String userAgentStr = ServletUtil.getHeaderIgnoreCase(request, Constants.USER_AGENT);
        UserAgent userAgent = UserAgentUtil.parse(userAgentStr);
        //判空
        if (ObjectUtil.isNotEmpty(userAgentStr)) {
            //如果根本没获取到浏览器
            if (Constants.UNKNOWN.equals(userAgent.getBrowser().getName())) {
                //则将ua设置为浏览器
